...
class VariationController extends GetxController {
  static VariationController get inatance => Get.find();
  ...
  void onAttributeSelected(ProductModel product, attributeName, attributeValue) {
    //when attribute is selected, we will first add the attribute to the selectedAttributes.
  ...
  bool _isSameAttributeValues(Map<String, dynamic> variationAttributes, Map<String, dynamic> selectedAttributes) {
    ...
    //If any of the attribte is different then return Eg [Green, Large] x [Green, Small]
    for (final key in variationAttributes.keys) {
      //Attributes[Key] = Value which would be [Green, Small, Cotton] etc.
  ...
  //Check product variation stock variation
